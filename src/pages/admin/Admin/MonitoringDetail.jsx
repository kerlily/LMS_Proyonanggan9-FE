          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white rounded-lg shadow p-4 border-l-4 border-blue-500">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600">Total Siswa Aktif</p>
            ...
            <div className="bg-white rounded-lg shadow p-4 border-l-4 border-red-500">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {data?.siswa_with_missing_nilai?.filter(s => s.mapel_missing?.length > 0).length || 0}
                  </p>
                </div>
              </div>
            </div>
                          ...
                          <div className="flex flex-col items-center">
                            <div className="w-20 bg-gray-200 rounded-full h-2 mb-1">
                              <div
                                ...
                                style={{
                                  width: `${Math.min(siswa.completion_rate, 100)}%`,
                                }}
                              ></div>
                            </div>
